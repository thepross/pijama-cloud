...
<template>
    <AppLayout :breadcrumbs="[
        ...
        { title: 'Nueva Oferta', href: '/ofertas/create' }
    ]">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-muted-foreground mt-1">
                        Define un nuevo descuento promocional para un producto textil y establece su vigencia.
                    </p>
                </div>
                <div>
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="p-6 rounded-xl border border-border bg-card shadow-sm space-y-4">
                            ...
                            <div class="grid gap-2">
                                ...
                                <Input id="nombre" type="text" required autofocus v-model="form.nombre" placeholder="ej. Descuento del Día del Padre, Black Friday, etc." class="rounded-xl" />
                        ...
                        <div class="p-6 rounded-xl border border-border bg-card shadow-sm space-y-4">
                            ...
                            <div class="grid gap-2">
                                <Label for="estado_oferta">Estado Inicial</Label>
                                <select
                                    id="estado_oferta"
                                    required
                                ...
                                >
                                    ...
                                    <option value="inactiva">Inactiva (Pausar manualmente)</option>
                                </select>
