...
import { Paintbrush, ArrowRight, Sparkles, Star, ShoppingBag, Shield, Heart, Mail, MapPin, Phone, Check, Shirt } from 'lucide-vue-next';
...
<template>
    ...
    <div class="min-h-screen flex flex-col bg-background text-foreground transition-colors duration-300">
        <!-- Navigation Header -->
        <header
            class="sticky top-0 z-40 w-full border-b border-border/80 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
            <div class="container mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6">
                ...
                <div class="flex items-center gap-2 cursor-pointer" @click="scrollToSection('inicio')">
                    <div
                        ...
                        <svg viewBox="0 0 24 24" class="size-5 stroke-primary-foreground fill-none" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round">
                            <path
                                d="M3 10V5C3 4.44772 3.44772 4 4 4H8C8 5 8.8 7 12 7C15.2 7 16 5 16 4H20C20.5523 4 21 4.44772 21 5V10C21 10.5523 20.5523 11 20 11H19C18.4477 11 18 11.4477 18 12V19C18 19.5523 17.5523 20 17 20H7C6.44772 20 6 19.5523 6 19V12C6 11.4477 5.55228 11 5 11H4C3.44772 11 3 10.5523 3 10Z" />
                        </svg>
                    </div>
                ...
                <nav class="hidden md:flex items-center gap-6 text-sm font-medium text-muted-foreground">
                    <button @click="scrollToSection('caracteristicas')"
                        class="hover:text-foreground transition-colors">Características</button>
                    <button @click="scrollToSection('acerca')"
                        class="hover:text-foreground transition-colors">Nosotros</button>
                    <button @click="scrollToSection('contacto')"
                        class="hover:text-foreground transition-colors">Contacto</button>
                </nav>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <Dialog>
                        <DialogTrigger as-child>
                            <Button variant="ghost" size="icon" class="h-9 w-9 rounded-lg"
                                title="Personalizar tema y accesibilidad">
                    ...
                    <template v-else>
                        <Link :href="route('login')"
                            class="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors px-2">
                            Iniciar sesión
                        </Link>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                    ...
                    <div class="lg:col-span-7 space-y-6 text-center lg:text-left">
                        ...
                        <h1
                            ...
                            <span
                                class="text-primary bg-gradient-to-r from-primary to-primary/80 bg-clip-text text-transparent">diseñado
                                para soñar.</span>
                        </h1>
                        <p class="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                            Descubre la comodidad absoluta con nuestras pijamas confeccionadas con materiales premium.
                            Elige tu
                        ...
                        <div class="flex flex-wrap justify-center lg:justify-start gap-4">
                            ...
                            <Button size="lg" variant="outline" @click="scrollToSection('caracteristicas')"
                                class="font-semibold">
                                Saber más
                            </Button>
                        </div>
                    ...
                    <div class="lg:col-span-5 flex justify-center lg:justify-end">
                        <div
                            ...
                            <div class="flex items-center justify-between">
                                <span class="text-xs font-bold uppercase tracking-widest text-primary">Tejido
                                    Premium</span>
                            ...
                            <div class="flex items-center justify-between border-t border-border/80 pt-4">
                                <div>
                                    <span class="text-xs text-muted-foreground block leading-none">Precio
                                        especial</span>
            ...
            <div class="container mx-auto max-w-7xl px-4 sm:px-6">
                <div class="text-center max-w-3xl mx-auto space-y-4 mb-16">
                    ...
                    <p class="text-lg text-muted-foreground">
                        Nuestra plataforma ofrece características avanzadas de personalización visual y operativa
                        pensadas para
                        todos.
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div
                        ...
                        <p class="text-muted-foreground leading-relaxed">
                            Cambia la apariencia del sitio con estilos adaptados especialmente para
                            <strong>Niños</strong>,
                            <strong>Jóvenes</strong> y <strong>Adultos</strong>, además del modo inteligente
                            <strong>Día/Noche</strong>.
                        </p>
                    </div>
                    ...
                    <div
                        ...
                        <p class="text-muted-foreground leading-relaxed">
                            Ajusta el contraste a blanco y negro puro y escala las tipografías para facilitar la lectura
                            a
                    ...
                    <div
                        ...
                        <p class="text-muted-foreground leading-relaxed">
                            Consulta tallas, colores, categorías y ofertas activas en un catálogo visual moderno y
                            controla el
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div class="space-y-6">
                        ...
                        <p class="text-lg text-muted-foreground leading-relaxed">
                            Nacimos con el objetivo de llevar el confort al siguiente nivel. Diseñamos pijamas a partir
                            de
                            textiles 100% orgánicos, suaves e hipoalergénicos, pensados para maximizar la relajación.
                        </p>
                        <p class="text-lg text-muted-foreground leading-relaxed">
                            Además, creemos firmemente en la tecnología inclusiva. Por eso, nuestro sitio incorpora
                            herramientas
                            avanzadas de diseño adaptable para asegurar que cualquier persona pueda navegar sin barreras
                            visuales.
                        </p>
                    ...
                    <div class="flex justify-center">
                        <div
                            class="relative p-6 border border-border rounded-2xl bg-card shadow-sm max-w-md w-full space-y-4">
                            ...
                            <ul class="space-y-3 text-sm">
                                <li class="flex items-start gap-2">
                                    ...
                                    <span><strong>Calidad:</strong> Costuras reforzadas y tejidos
                                        hipoalergénicos.</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <Check class="h-5 w-5 text-primary shrink-0 mt-0.5" />
                                    <span><strong>Inclusión:</strong> Accesibilidad web de nivel superior
                                        (WAI-ARIA).</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <Check class="h-5 w-5 text-primary shrink-0 mt-0.5" />
                                    <span><strong>Transparencia:</strong> Matriz de acceso clara y bitácora de
                                        auditoría.</span>
                                </li>
                            </ul>
                        </div>
                        ...
                        <form @submit="submitContactForm"
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div class="space-y-2">
                                    ...
                                    <input id="name" v-model="contactForm.nombre" type="text" required
                            ...
                            <div class="space-y-2">
                                ...
                                <textarea id="message" v-model="contactForm.mensaje" required rows="4"
                                    placeholder="Hola, me gustaría saber sobre las pijamas de niños..."
                                    class="flex w-full rounded-md border border-input bg-background px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"></textarea>
                            </div>
                            ...
                            <div v-if="isSubmitted"
                                class="p-3 bg-green-500/10 text-green-600 dark:text-green-400 rounded-md text-sm text-center font-medium animate-pulse">
